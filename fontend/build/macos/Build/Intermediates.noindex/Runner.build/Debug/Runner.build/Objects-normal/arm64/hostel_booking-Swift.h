...
#ifndef HOSTEL_BOOKING_SWIFT_H
#define HOSTEL_BOOKING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hostel_booking",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14hostel_booking11AppDelegate")
...
SWIFT_CLASS("_TtC14hostel_booking17MainFlutterWindow")
